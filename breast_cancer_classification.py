...
Original file is located at
    https://colab.research.google.com/drive/1YqC_eGDk-SLYqn2B9ogKmqYKqN5-Fkfx
"""
...
#if feature column is given then it is supervised
# if feature column is not given then it is unsupervised learning
...
# EDA : Exploratory data analysis  is used by data scientists to analyze and investigate data sets and summarize their main characteristics, often employing data visualization methods.

# each row its having 6 columns
# density graph
...
#removing all the negative features
...
# Find features with correlation less than 0.92
...
# 32 freature reduce to 23 feature
...
# 455 rows and 22 columns

# Applu machine learning Algorithm
...
# max Feature(int)                 max Feature(float)
#      20                               1.0
#      15                               0.75
#      10                               0.5
#      5                                0.25
